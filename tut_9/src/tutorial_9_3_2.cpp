...
#include "tutorial_9_3_2.h"

ImageOverlay::ImageOverlay()
    : Node("tutorial_9_3_2")
{
    background_ = cv::imread("/home/student/git/RS1_-_Cant_Spot/ros2_ws/src/tut_9/images/car_junction_map2.png", cv::IMREAD_UNCHANGED);
    foreground_ = map("/home/student/git/RS1_-_Cant_Spot/ros2_ws/src/tut_9/images/car_junction_map2.pgm");
...
cv::Mat ImageOverlay::map(const std::string& input_pgm)
{
...
void ImageOverlay::overlayImages()
{
